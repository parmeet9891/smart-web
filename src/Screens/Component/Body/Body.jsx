              ...
              <div className="col-md-4" style = {{marginTop: -10, borderRadius: 3}}>
                <div className="thumbnail">
                  ...
                  <div className="caption">
                    ...
                    <Link to = "/mobile/all"> <button className = "btn btn-primary">Explore</button>  </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-4" style = {{marginTop: -10, borderRadius: 3}}>
                <div className="thumbnail">
                  ...
                  <div className="caption">
                    ...
                    <Link to = "/laptops/all"> <button className = "btn btn-primary">Explore</button>  </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-4" style = {{marginTop: -10, borderRadius: 3}}>
                <div className="thumbnail">
                  ...
                  <div className="caption">
                    ...
                    <Link to = "/camera/all"> <button className = "btn btn-primary">Explore</button>  </Link>
                  </div>
                </div>
              </div>
